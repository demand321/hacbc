  ...
  try {
    ...
    const product = await prisma.product.create({
      data: {
        ...
        sizes: [...new Set(body.sizes ?? [])],
        variants: [...new Set(body.variants ?? [])],
        allVariants: [...new Set(body.allVariants ?? [])],
  ...
  try {
    ...
    const product = await prisma.product.update({
      ...
      data: {
        ...
        sizes: [...new Set(data.sizes ?? [])],
        variants: [...new Set(data.variants ?? [])],
        allVariants: [...new Set(data.allVariants ?? [])],
